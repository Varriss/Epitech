...
void init_player_pos_and_rect(player_cursor_t *player_c, sfVector2f spawnpos)
{
...
player_cursor_t *create_player_cursor(sfVector2f spawnpos)
{
    ...
    player_c->view = sfView_createFromRect((sfFloatRect) {600, 600, 1600, 900});
    ...
    init_player_pos_and_rect(player_c, spawnpos);
    ...
    player_c->inventory = init_inventory();
